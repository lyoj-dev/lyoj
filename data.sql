CREATE TABLE contest (id int(255) NULL,title longtext NULL,starttime int(20) NULL,duration int(20) NULL,type int(11) NULL,rated tinyint(1) NULL DEFAULT 0);
...
CREATE TABLE problem (id int(255) NULL,name longtext NULL,bg longtext NULL,descrip longtext NULL,input longtext NULL,output longtext NULL,cases longtext NULL,hint longtext NULL,hidden tinyint(1) NULL DEFAULT 0,banned tinyint(1) NULL DEFAULT 0,difficult int(11) NULL DEFAULT 0,contest int(255) NULL DEFAULT 0);
