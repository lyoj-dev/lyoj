<?php
    ...
    CheckParam(array("pid","ppid"),$_POST);
    ...
    $problem_controller->UpdateProblem(
        ...
        $_POST["spj_compile"],$_POST["spj_name"],$_POST["spj_param"],$tags);
